...
### Top 20 der post-Benchmark-Matrix
...
| 2 | [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | 72.038 | 77,0 | sehr stark für CLI-Ausgaben, kein allgemeiner Prompt-Rewriter |
...
| 5 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | 142.168 | 75,0 | ContextualCompressionRetriever |
| 6 | [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) | 21.105 | 74,5 | Gateway mit gestapelter Kompression |
| 7 | [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | 91.104 | 71,0 | aggressive Sprachverkürzung, Präzisionsrisiko |
...
| 13 | [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) | 121.042 | 68,0 | lokaler Billigmodell-Host, kein Compressor |
...
| 16 | [3DAgentWorld/Toolkit-for-Prompt-Compression](https://github.com/3DAgentWorld/Toolkit-for-Prompt-Compression) | 291 | 65,5 | Forschungs-Toolkit zum reproduzierbaren Methodenvergleich |
| 17 | [RUC-NLPIR/FlashRAG](https://github.com/RUC-NLPIR/FlashRAG) | 3.525 | 64,5 | RAG-Forschungs-Toolkit mit Kompressionsbausteinen |
| 18 | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | 23.438 | 64,5 | Eval-/Red-Team-Gate, komprimiert nicht selbst |
| 19 | [vllm-project/vllm](https://github.com/vllm-project/vllm) | 86.710 | 62,0 | Serving-/KV-Layer, spart keine übertragenen API-Tokens |
| 20 | [jina-ai/late-chunking](https://github.com/jina-ai/late-chunking) | 532 | 60,0 | bessere Retrieval-Selektion, kein allgemeiner Rewriter |

Stars sind ein am 20.07.2026 um 17:55 CEST live per GitHub-API erhobener Snapshot und können sich nach dem Erfassungszeitpunkt ändern. Popularität ist absichtlich nur 5/100 Punkte wert. Alle 20 sichtbaren Kandidaten sind echte GitHub-Repositories; die vollständige Rohmatrix bewertet 50 Repositories.
