...
| 🚀 | Publication | GitHub-Blob-Link und gerenderte Datei | Done | 100% | 95% | Passed | Screenshot: `proofs/github-report-rendered.png` | [Öffentlicher Report](https://github.com/Martin-Hausleitner/headroom-context-idr/blob/main/headroom-context-report.md) | Bei Report-Updates erneut Browser- und Quality-Gate prüfen |
